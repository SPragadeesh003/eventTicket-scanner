...
export class Ticket extends Model {
  ...
  get ticket_type(): string  { return this._getRaw('ticket_type') as string; } // regular | guest_list | external
  get status():      string  { return this._getRaw('status')      as string; } // valid | used
  get synced_at():   number  { return this._getRaw('synced_at')   as number; } // epoch ms
...
export class SyncedEvent extends Model {
  ...
  get last_synced_at(): number { return this._getRaw('last_synced_at') as number; } // epoch ms
